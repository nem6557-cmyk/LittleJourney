...
INSERT INTO children (id, daycare_id, classroom_id, first_name, last_name, date_of_birth, allergies) VALUES
  ('k0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Layla', 'Ahmed', '2023-03-15', ARRAY['Peanuts']),
  ('k0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000002', 'Adam', 'Ahmed', '2021-11-20', '{}'),
  ('k0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Sophia', 'Johnson', '2023-06-10', '{}'),
  ('k0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Noah', 'Kim', '2023-01-05', '{}'),
  ('k0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000002', 'Aria', 'Singh', '2022-05-17', ARRAY['Gluten']),
  ('k0000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000002', 'Liam', 'Brown', '2022-07-30', '{}'),
  ('k0000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Mia', 'Chen', '2023-04-12', '{}'),
  ('k0000000-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000003', 'Ethan', 'Davis', '2024-09-25', ARRAY['Eggs']);
...
--   ('<parent-auth-uid>', 'k0000000-0000-0000-0000-000000000001', 'parent'),
--   ('<parent-auth-uid>', 'k0000000-0000-0000-0000-000000000002', 'parent');
--
